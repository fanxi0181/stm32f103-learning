...
- **2025 下半年**：首次接触 STM32，参与机器狗实训，自学 C 语言和标准外设库
- **2026 上半年**：持续学习外设驱动、中断系统、RTOS 等，积累裸机练习代码
- **2026.06**：开始用 Git 系统管理代码，将之前的练习和项目重新闭卷手写整理，逐日提交至本仓库

> 本仓库 commit 集中在 6 月，是因为这时才开始用 Git 记录，并非从头学起。代码经过反复调试和重构，仓库只是呈现了最终整理后的结果。
